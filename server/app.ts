...
// app.post("/resource-save", async (req, res) => {
//   const resource: Resource.Resource = req.body.resource
//   console.log("recievedResult", resource)
//   res.send(await addResource(resource.name, []))
// })
