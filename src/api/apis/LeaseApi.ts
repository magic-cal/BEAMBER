...
export class LeaseApi extends runtime.BaseAPI {
    ...
    async deleteLeaseRaw(requestParameters: DeleteLeaseRequest): Promise<runtime.ApiResponse<boolean>> {
        if (requestParameters.leaseId === null || requestParameters.leaseId === undefined) {
            throw new runtime.RequiredError('leaseId','Required parameter requestParameters.leaseId was null or undefined when calling deleteLease.');
        }
    ...
    async getLeaseRaw(requestParameters: GetLeaseRequest): Promise<runtime.ApiResponse<Lease>> {
        if (requestParameters.leaseId === null || requestParameters.leaseId === undefined) {
            throw new runtime.RequiredError('leaseId','Required parameter requestParameters.leaseId was null or undefined when calling getLease.');
        }
    ...
    /**
     */
    async updateOrCreateLeaseRaw(requestParameters: UpdateOrCreateLeaseRequest): Promise<runtime.ApiResponse<QueryResultAny>> {
        if (requestParameters.lease === null || requestParameters.lease === undefined) {
            throw new runtime.RequiredError('lease','Required parameter requestParameters.lease was null or undefined when calling updateOrCreateLease.');
        }
